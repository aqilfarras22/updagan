  ...
  <div class="pt-10">
    ...
    <b-row>
      <b-col :class="componentData.isEditedVersion?'col-6':'col-10'" class="pl-30">
        ...
        <div class="mb-6">{{componentData.sequence}}. {{componentData.question}}</div>
        <div class="ml-15">
          <b-row>
            <b-col v-for="(answer, index) in componentData.answerText" :key="index" class="pl-0 pr-0" cols="4">
              <b-row>
                <b-col align-self="center" class="pl-0">
                  <span class="text-align answers">{{answer.answerText}}</span>
                </b-col>
              </b-row>
            </b-col>
          </b-row>
      ...
      <b-col v-if="componentData.isEditedVersion" class="col-6 previous-answer">
        ...
        <div>
          <b-row>
            <b-col v-for="(answer, index) in componentData.previousAnswerText" :key="index" class="pl-0 pr-0" cols="4">
              <b-row>
                <b-col align-self="center" class="pl-0">
                  <span class="text-align answers">{{answer.answerText}}</span>
                </b-col>
