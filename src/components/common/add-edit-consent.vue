<template>
  ...
  <div class="edit_only_screen">
    ...
    <div class="pt-20">
      ...
      <quill-editor class="bg-white" ref="econsentRef" v-model="selectedConsentSection.sectionHtmlContent" :options="editorOption">
      </quill-editor>
    </div>
    <div class="row pt-20">
      <div class="col-lg-9 col-md-9 col-sm-6 col-xs-2 p-0">
        <button class="btn btn-link pb-15 color_red pl-0" v-on:click="deleteConsentSection()">Delete</button>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-10 text-right p-0">
        <button class="btn btn-link pb-15 color_aa" v-on:click="cancelConsentSection()">Cancel</button>
        <button class="btn btn-success save_btn mb-10 br-30" v-on:click="saveConsentSection()">Save</button>
      </div>
    </div>
