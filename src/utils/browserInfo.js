const isBrowserOs = {
  ...
  ie: () =>
    window.navigator.userAgent.match(/MSIE/i) || window.navigator.userAgent.match(/Trident\/7.0/i), // eslint-disable-line
...
if (isBrowserOs.blackBerry()) {
  htmlClass = 'blackberry';
}

// Browser
if (isBrowserOs.chrome()) {
  htmlClass = `${htmlClass} chrome`;
}
if (isBrowserOs.firefox()) {
  htmlClass = `${htmlClass} firefox`;
}
if (isBrowserOs.ie()) {
  htmlClass = `${htmlClass} ie`;
}
if (isBrowserOs.opera()) {
  htmlClass = `${htmlClass} opera`;
}
if (isBrowserOs.seaMonkey()) {
  htmlClass = `${htmlClass} seamonkey`;
}
if (isBrowserOs.camino()) {
  htmlClass = `${htmlClass} camino`;
}
if (isBrowserOs.safari()) {
  htmlClass = `${htmlClass} safari`;
}

export const browserClassNames = htmlClass;
export const browser = isBrowserOs;
